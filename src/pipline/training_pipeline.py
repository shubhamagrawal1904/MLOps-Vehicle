...
class TrainPipeline:
    ...
    def start_data_ingestion(self)->DataIngestionArtifact:
        try:
            logging.info('Entered Data Ingestion of Training Pipeline')
            data_ingestion=DataIngestion(data_ingestion_config=self.data_ingestion_config)
            data_ingestion_artifact=data_ingestion.initiate_data_ingestion()
            logging.info('Got the train and test set data from MongoDB')
            logging.info('Exitid the start Data Ingestion method of TrainPipline Class')
    ...
    def start_data_validation(self, data_ingestion_artifact:DataIngestionArtifact)-> DataValidationArtifact:
        ...
        logging.info('Entering Data Validation method of Pipeline Class')
        
        data_validation=DataValidation(data_ingestion_artifact=data_ingestion_artifact,
                                       data_validation_config=self.data_validation_config)
        data_validation_artifact=data_validation.initiate_data_validation()
        logging.info('Performed Data Validation')
        logging.info('Exited Data Validation method of Pipeline Class')
    ...
    def start_model_evaluation(self, data_ingestion_artifact:DataIngestionArtifact, 
                               model_trainer_artifact:ModelPusherArtifact)->ModelEvaluationArtifact:
        try:
