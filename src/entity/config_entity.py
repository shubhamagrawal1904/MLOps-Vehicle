...
class DataIngestionConfig:
    data_ingestoin_dir:str=os.path.join(training_pipeline_config.artifact_dir,DATA_INGESTION_DIR_NAME)
    feature_store_file_path:str=os.path.join(data_ingestoin_dir, DATA_INGESTION_FEATURE_STORE_DIR, FILE_NAME)
    trainging_file_path:str=os.path.join(data_ingestoin_dir, DATA_INGESTION_INGESTED_DIR, TRAIN_FILE_NAME)
    testing_file_path:str=os.path.join(data_ingestoin_dir, DATA_INGESTION_INGESTED_DIR, TEST_FILE_NAME)
...
class DataValidationConfig:
    ...
    validation_report_file_path:str=os.path.join(data_validation_dir, DATA_VALIDATION_REPORAT_FILE_NAME)
